...
export default function UltimakerPage() {
  const ultimakerPrinters = getPrintersByBrand("Ultimaker");
    ...
    <div className="min-h-screen bg-[#0c0c0c] pt-24">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-light text-white mt-4 mb-6">ULTIMAKER</h1>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Professional desktop 3D printers trusted by engineers and designers worldwide. BuildVolume is South Africa&apos;s official Ultimaker partner.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <h2 className="text-2xl font-light text-white mb-8">Ultimaker 3D Printers</h2>
          {ultimakerPrinters.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
              {ultimakerPrinters.map((p) => (
                  ...
                  <div className="bg-[#1a1a1a] hover:bg-[#2a2a2a] transition-all duration-300 border border-white/5 hover:border-white/10">
                    <div className="aspect-square relative overflow-hidden bg-white">
                      {p.images[0] ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-[#1a1a1a] text-white/20 text-2xl">UM</div>
                      )}
                    </div>
                    <div className="p-4">
      ...
      <section className="py-20 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl font-light text-white mb-4">View All Ultimaker Products</h2>
          <Link
            href="/shop?brand=ultimaker"
