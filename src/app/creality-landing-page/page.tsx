...
export default function CrealityPage() {
  const crealityPrinters = getPrintersByBrand("Creality");
    ...
    <div className="min-h-screen bg-[#0c0c0c] pt-24">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-light text-white mt-4 mb-6">CREALITY</h1>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Affordable, reliable 3D printers for makers and professionals. BuildVolume is South Africa&apos;s official Creality partner.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <h2 className="text-2xl font-light text-white mb-8">Creality 3D Printers</h2>
          {crealityPrinters.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
              {crealityPrinters.map((p) => (
                  ...
                  <div className="bg-[#1a1a1a] hover:bg-[#2a2a2a] transition-all duration-300 border border-white/5 hover:border-white/10">
                    <div className="aspect-square relative overflow-hidden bg-white">
                      {p.images[0] ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-[#1a1a1a] text-white/20 text-2xl">CR</div>
                      )}
                    </div>
                    <div className="p-4">
      ...
      <section className="py-20 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl font-light text-white mb-4">View All Creality Products</h2>
          <Link
            href="/shop?brand=creality"
